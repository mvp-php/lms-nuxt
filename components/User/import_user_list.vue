        ...
        <table aria-multiselectable="true"
            ...
            <thead>
                <tr class="slds-line-height_reset">
                    ...
                    <th class=" slds-cell_action-mode" scope="col">First</th>
                    <th class=" slds-cell_action-mode" scope="col">Last</th>
...
<tr aria-selected="false" class="slds-hint-parent" v-for="(item, key) in deletedUserList" :key="item.id"  :id="`${item.id}`">
                    <td class="slds-cell_action-mode" role="gridcell">{{ key + 1 }}</td>
